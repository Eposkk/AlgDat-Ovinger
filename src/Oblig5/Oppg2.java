...
public class Oppg2 {
    ...
    private static void runTest(double p) {
        ...
        System.out.println("Fordi martin gårt indøk er han gay");
    }
    ...
    static class HashTableDouble extends HashTable {
    ...
    static class HashTableLinear extends HashTable {
    ...
    static class HashTableSquared extends HashTable {
